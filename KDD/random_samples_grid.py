"""Reproduction of "Randomly selected reconstructed samples on the MITBIH dataset"."""
...
with open("KDD/data/random_samples_mitbih.pkl", "rb") as f:
...
plt.show()
# plt.savefig('KDD/mitbih_grid.pgf')
# plt.savefig('KDD/mitbih_grid.pdf')
